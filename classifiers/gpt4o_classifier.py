...
def extract_frames(video_path, num_frames=8):
    """
    Extract evenly spaced frames from video for GPT-4o analysis.
...
def classify_video_gpt4o(video_path, classes, max_retries=3):
    """
    Classify video using GPT-4o Vision API.
    ...
    """
    print(f"  Classifying with GPT-4o-mini Vision...")
...
def process_all_videos(video_dir='sampled_videos', output_csv='gpt4o_predictions2.csv'):
    """
    ...
    print(f"\n{'='*60}")
    print(f"GPT-4o-mini Video Classification")
    print(f"{'='*60}")
